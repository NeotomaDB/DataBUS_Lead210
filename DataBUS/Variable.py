class Variable:
    def __init__(self, taxonid = None, variableelementid = None,
                 variableunitsid = None, variablecontextid = None):
          self.varid = None
    ...
    def get_id_from_db(self, cur):
         variable_q = """
                ...
                """
         inputs = {'variableunitsid': self.variableunitsid,
