class Sample:
    def __init__(self, analysisunitid = None, datasetid = None, 
                 samplename = None, sampledate = None, 
                 analysisdate = None, taxonid = None, 
                 labnumber = None, prepmethod = None, 
                 notes = None):
    ...
    def insert_to_db(self, cur):
        ...
        SELECT ts.insertsample(_analysisunitid := %(analysisunitid)s,
                               ...
                               _notes := %(notes)s)
                        """
        inputs = {'analysisunitid': self.analysisunitid,
